...
<div class="pad-lr-10">
    <form name="searchform" action="<?php echo site_url('/ad/view_list');?>" method="post" >
  ...
  <form id="myform" name="myform" action="<?php echo site_url('/ad/delete');?>" method="post">
    <div class="table-list">
      <table width="100%" cellspacing="0">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td align="center"><a class="blue" href="<?php echo site_url('/ad/edit/'.$val['id']);?>">编辑</a></td>
          </tr>
		 <?php endforeach;?>
        </tbody>
      </table>
	  <div class="btn">
	    ...
	    <input type="submit" class="button" name="order" onclick="document.myform.action='<?php echo site_url('/ad/order');?>'" value="排序" style="float:left;margin:0 10px 0 0;"/>
