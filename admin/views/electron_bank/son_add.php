...
<form action="<?php echo site_url('/electron_bank/son_add/'.$parent_id);?>" method="post" name="myform" id="myform">
<input type="hidden" name="parent_id" id="parent_id" value="<?php echo $parent_id;?>">
  <div class="pad-10">
  <div class="col-tab">
  <ul class="tabBut cu-li">
    <li id="tab_setting_1" class="on" onclick="SwapTab('setting','on','',2,1);">子项目基本信息</li>
  </ul>
  ...
  <div class="btn">
    ...
    <input type="button" value="返回" class="button" onclick="window.location.href='<?php echo site_url('/electron_bank/view_list/');?>'">
  </div>
</div>
</div>
</form>
