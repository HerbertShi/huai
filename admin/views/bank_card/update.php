...
<form action="<?php echo site_url('/bank_card/update/');?>" method="post" name="myform" id="myform"  enctype="multipart/form-data">
<input type="hidden" name="id" id="id" value="<?php echo $item_info['id'];?>"/>
  ...
  <div id="div_setting_1" class="contentList pad-10">
    <table width="100%" cellpadding="2" cellspacing="1" class="table_form">
      ...
      <tr>
        <th width="100">图片:</th>
        <td>
	         <img id="img_show" src="<?php  echo $item_info['img']; ?>" width="210px" height="210px"/><br /><br />
  ...
  <div class="btn">
    ...
    <input type="button" value="返回" class="button" onclick="javascript:window.location.href='<?php echo site_url('/bank_card/view_list/');?>'">
  </div>
</div>
</div>
</form>
