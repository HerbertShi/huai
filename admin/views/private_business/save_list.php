...
<a href="<?php echo site_url('/private_business/add_save/'); ?>" class="button1">发布新内容</a>
<div class="pad-lr-10">
<form name="searchform" action="<?php echo site_url('/private_business/save_list');?>" method="post" >
...
<form id="myform" name="myform" action="<?php echo site_url('/private_business/delete_save');?>" method="post" onsubmit="return check();">
      ...
      <table width="100%" cellspacing="0">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td align="center"><a href="<?php echo site_url('/private_business/save_info/'.$item['id']); ?>"><?php echo $item['title']?></a></td>
            <td align="center">
            <?php 
            ...
            <td align="center">
            	<a  class="blue" href="<?php echo site_url('/private_business/update_save/'.$item['id']); ?>">编辑</a>
            	<a  class="blue" href="<?php echo site_url('/private_business/save_info/'.$item['id']); ?>">详情</a>
            </td>
          </tr>
          <?php endforeach;?>
        </tbody>
