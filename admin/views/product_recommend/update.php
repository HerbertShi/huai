...
<form action="<?php echo site_url('/product_recommend/update/');?>" method="post" name="myform" id="myform">
<input type="hidden" name="id" id="id" value="<?php echo $item_info['id'];?>"/>
  ...
  <div class="btn">
    ...
    <input type="button" value="返回" class="button" onclick="javascript:window.location.href='<?php echo site_url('/product_recommend/view_list/');?>'">
  </div>
</div>
</div>
</form>
