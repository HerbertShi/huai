...
<div class="pad-lr-10">
<form name="searchform" action="<?php echo site_url('/promotion/view_list');?>" method="post" >
...
<form id="myform" name="myform" action="<?php echo site_url('/promotion/delete');?>" method="post" onsubmit="return check();">
    <div class="table-list">
      <table width="100%" cellspacing="0">
        ...
        <tbody>
          <?php foreach($promotion_list as $i=>$item):?>
          <tr>
          	<td align="center"><?php echo $item['id'];?></td>
            <td align="center"><input type="checkbox" value="<?php echo $item['id'];?>" name="id[]"></td>
            <td align="center"><a href="<?php echo site_url('/promotion/item_info/'.$item['id']); ?>"><?php echo $item['title']?></a></td>
            <td align="center">
            <?php 
            ...
            <td align="center">
            	<a  class="blue" href="<?php echo site_url('/promotion/update/'.$item['id']); ?>">编辑</a>
            	<a  class="blue" href="<?php echo site_url('/promotion/item_info/'.$item['id']); ?>">详情</a>
            </td>
          </tr>
          <?php endforeach;?>
        </tbody>
