<?php
class News extends Bank_Controller {
	...
	function view_list() {
		...
		$this->load->view('/news/view_list', $data);
	}
	...
	function item_info() {
		...
		if ($obj_id != '') {
			...
			$this->load->helper('url');
			$this->load->view('/news/item_info',$data);
		}
	}
	...
	public function delete(){
		...
		if (!empty($ids_array)) {
			...
			$this->load->helper('url');
			redirect('/news/view_list', 'refresh');
		}
	}
