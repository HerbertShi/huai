<?php
class Promotion extends Bank_Controller {
	...
	function view_list() {
		...
		$this->load->view('/promotion/view_list', $data);
	}
	...
	function item_info() {
		...
		if ($obj_id != '') {
			...
			$this->load->helper('url');
			$this->load->view('/promotion/item_info',$data);
		}
	}
	...
	function update() {
		...
		if ($obj_id != "") {
			...
			$this->load->helper('url');
			$this->load->view('/promotion/update',$data);
	...
	public function delete(){
		...
		if (!empty($ids_array)) {
			...
			$this->load->helper('url');
			redirect('/promotion/view_list', 'refresh');
		}
	}
