  ...
  <div class="container">
    <div class="contain"> 
      ...
      <div class="article fr"> 
        <!--bread area-->
        <div class="bread"><a href="../index.html">主页</a>&gt;<a href="about-us.html">关于本行</a>&gt;<span>银行新闻</span></div>
        <!--block card-->
          ...
          <div class="content">
            <div class="news">
              ...
              <?php foreach($news as $i=>$item):?>
                <li><span class="fr"><?php echo date('Y-m-d H:i:s',$item['add_time']);?></span><a href="<?php echo site_url('/news/info/'.$item['id']);?>"><?php echo $item['title'];?></php></a></li>
              <?php endforeach;?>
              </ul>
            </div>
            <div class="page"><?php  echo $paginate;?></div>
          </div>
        </div>
      </div>
      <!--left area-->
