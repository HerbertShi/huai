      ...
      <div class="article fr"> 
        ...
        <div class="block card">
          ...
          <div class="content">
            <div class="news">
              <ul>
              <?php foreach($promotion as $i=>$item):?>
                <li><span class="fr"><?php echo date('Y-m-d H:i:s',$item['add_time']);?></span><a href="<?php echo site_url('/promotion/info/'.$item['id']);?>"><?php echo $item['title'];?></php></a></li>
              <?php endforeach;?>
              </ul>
            </div>
